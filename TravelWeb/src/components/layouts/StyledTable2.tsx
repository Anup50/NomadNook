  ...
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  ...
                  {colIndex === headers.length - 1 ? (
                    ...
                    <>
                      ...
                      <td className="px-4 py-2 text-center">
                        <button className="bg-slate-900 text-white px-4 py-2 rounded" onClick={() => handleDeleteClick(row)}>
                          <MdOutlineDelete /> 
      ...
      <div className="flex justify-center mt-5 mb-5">
        <button
          className="bg-slate-900 text-white rounded-md px-4 py-2 transition duration-300 ease-in-out hover:bg-green-800"
